...
def user_input_features():
    item = st.selectbox("Item", ['Bread', 'Scandinavian', 'Hot chocolate', 'Jam', 'Cookies', 'Muffin', 'Coffee', 'Pastry', 'Medialuna', 'Tea'])
    ...
    month = st.select_slider('Month', ["Jan", "Feb", "Mar", "Apr", "May", "Jun"])
...
if type(data) != type("No Result"):
    ...
    st.success(f"Jika customer membeli **{item}**, maka membeli **{return_item_df(item)[1]}** secara bersamaan")
